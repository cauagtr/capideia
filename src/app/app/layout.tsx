...
import { Clapperboard, Heart, Star, MessageCircle, User } from 'lucide-react'
import Link from 'next/link'

const tabs = [
  { href: '/app/inicio', icon: Clapperboard, label: 'Reels' },
  ...
  return (
    <div className="app-shell flex flex-col min-h-dvh">
      ...
      <nav style={{
        ...
        borderTop: '1px solid #2a2a2a', zIndex: 50,
          ...
          {tabs.map(({ href, icon: Icon, label, special }) => {
            ...
            return (
              <Link key={href} href={href} style={{
                ...
                {active && !special && <div style={{ width: '4px', height: '4px', borderRadius: '50%', background: '#00c853' }} />}
              </Link>
            )
          })}
        </div>
